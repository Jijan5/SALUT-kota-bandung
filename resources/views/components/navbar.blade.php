...
<header id="navbar" class="fixed top-0 left-0 right-0 z-50 bg-white/95 border-b border-slate-100 shadow-sm transition-all duration-300 backdrop-blur-md">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-20">
            ...
            <nav class="hidden md:flex items-center space-x-8">
                ...
                <a href="/pendaftaran" class="bg-blue-700 hover:bg-blue-800 text-white font-bold px-5 py-2.5 rounded-xl text-sm transition shadow-md shadow-blue-500/20">Daftar Sekarang</a>
            </nav>
    ...
    <div id="mobile-menu" class="hidden md:hidden bg-white border-b border-slate-100 px-4 pt-2 pb-4 space-y-1 shadow-sm">
        ...
        <a href="/pendaftaran" class="block px-3 py-2 rounded-lg bg-blue-700 text-white font-bold text-sm text-center mt-2">Daftar Sekarang</a>
    </div>
</header>
