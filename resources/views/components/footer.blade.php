        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
            ...
            <div>
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <a href="https://youtube.com/@mitraprianganbandung?si=-sl5-KxAhzcah2Hk" target="_blank" rel="noopener noreferrer" class="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center text-slate-400 hover:bg-red-600 hover:text-white hover:scale-110 transition duration-300" title="YouTube">
                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
