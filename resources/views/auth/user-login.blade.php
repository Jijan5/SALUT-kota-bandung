    ...
    <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-slate-900 via-blue-950 to-indigo-950 relative overflow-hidden flex-col justify-between p-12">
        ...
        <div class="relative z-10 text-center">
            <div class="float-animation inline-block mb-8">
                <div class="w-32 h-32 rounded-3xl bg-white/10 backdrop-blur-sm border border-white/20 flex items-center justify-center mx-auto shadow-2xl p-4">
                    <img src="{{ asset('images/icon-web.png') }}" alt="Icon Web" class="h-full w-full object-contain drop-shadow-md">
                </div>
            </div>
