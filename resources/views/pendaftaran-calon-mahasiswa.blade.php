                ...
                <div class="step-pane step-transition hidden" id="step3">
                            ...
                            <div class="relative border-2 border-slate-200 rounded-2xl p-6 cursor-pointer hover:border-brand-300 transition duration-300" id="card_jalur_rpl">
                                <div class="flex items-start">
                                    ...
                                    <label for="jalur_program_rpl" class="ml-3 cursor-pointer">
                                        ...
                                        <span class="inline-block mt-3 bg-brand-50 text-brand-700 text-xs font-bold px-2.5 py-1 rounded-md"><span>Uang Pendaftaran + Jasa Layanan SALUT Rp. 800.000</span>
                                        <span class="inline-block mt-3 bg-brand-50 text-brand-700 text-xs font-bold px-2.5 py-1 rounded-md"><span>Uang Kuliah Mulai Rp 1.300.000 s/d Rp 2.200.000</span>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="relative border-2 border-slate-200 rounded-2xl p-6 cursor-pointer hover:border-brand-300 transition duration-300" id="card_jalur_nonrpl">
                                <div class="flex items-start">
                                    ...
                                    <label for="jalur_program_nonrpl" class="ml-3 cursor-pointer">
                                        ...
                                        <span class="inline-block mt-3 bg-slate-100 text-slate-700 text-xs font-bold px-2.5 py-1 rounded-md">Uang Pendaftaran + Jasa Layanan SALUT Rp. 500.000</span>
                    ...
                    <div id="rpl_description" class="hidden mb-8 p-6 rounded-2xl bg-amber-50 border border-amber-200/60 text-slate-700">
                        ...
                        <ul class="list-disc list-inside text-sm space-y-1.5 ml-1 text-slate-600">
                            <li>Jasa Layanan SALUT Rp 400.000 (Admisi pendaftaran Registrasi Pendampingan & verifikasi dokumen aktivasi sampai menjadi Mahasiswa UT serta layanan akademik lainya)</li>
                ...
                <div class="step-pane step-transition hidden" id="step4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                        ...
                        <div class="border border-slate-200 rounded-2xl p-5 hover:bg-slate-50 transition duration-300">
                            ...
                            <span class="block text-xs text-slate-400 mb-3">Format: JPG, JPEG, PNG (Maks 25MB). Background biru/merah, rapi dan formal.</span>
                        ...
                        <div class="border border-slate-200 rounded-2xl p-5 hover:bg-slate-50 transition duration-300">
                            ...
                            <span class="block text-xs text-slate-400 mb-3">Format: JPG, JPEG, PNG (Maks 25MB). Pastikan NIK dan tulisan terbaca jelas.</span>
                        ...
                        <div class="border border-slate-200 rounded-2xl p-5 hover:bg-slate-50 transition duration-300">
                            ...
                            <span class="block text-xs text-slate-400 mb-3">Format: PDF Asli / Fotokopi (Legalisir Cap Basah) (Maks 25MB).</span>
                        ...
                        <div class="border border-slate-200 rounded-2xl p-5 hover:bg-slate-50 transition duration-300">
                            ...
                            <span class="block text-xs text-slate-400 mb-3">Format: PDF (Maks 25MB). Cetak, isi data, tanda tangan materai 10rb, dan scan.</span>
                    ...
                    <div id="rpl_file_section" class="hidden border-t border-slate-100 pt-8 mt-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="border border-amber-100 bg-amber-50/20 rounded-2xl p-5 hover:bg-slate-50 transition duration-300">
                                ...
                                <span class="block text-xs text-slate-400 mb-3">Format: JPG, JPEG, PNG (Maks 25MB). Status terdaftar aktif / lulus di Universitas lama.</span>
                            ...
                            <div class="border border-amber-100 bg-amber-50/20 rounded-2xl p-5 hover:bg-slate-50 transition duration-300">
                                ...
                                <span class="block text-xs text-slate-400 mb-3">Format: PDF (Maks 25MB). Unduh formulir di atas, isi lengkap riwayat Anda, simpan sebagai PDF.</span>
                            ...
                            <div class="border border-slate-200 rounded-2xl p-5 hover:bg-slate-50 transition duration-300 col-span-1 md:col-span-2">
                                ...
                                <span class="block text-xs text-slate-400 mb-3">Format: PDF (Maks 25MB). Hanya bagi calon mahasiswa pindahan antar universitas.</span>
                            ...
                            <div class="border border-slate-200 rounded-2xl p-5 hover:bg-slate-50 transition duration-300">
                                ...
                                <span class="block text-xs text-slate-400 mb-3">Format: PDF (Maks 25MB). RPP, Silabus, modul buatan sendiri, atau instrumen evaluasi.</span>
                            ...
                            <div class="border border-slate-200 rounded-2xl p-5 hover:bg-slate-50 transition duration-300">
                                ...
                                <span class="block text-xs text-slate-400 mb-3">Format: PDF (Maks 25MB). Surat keputusan pembagian tugas mengajar, daftar nilai siswa, absensi.</span>
                            ...
                            <div class="border border-slate-200 rounded-2xl p-5 hover:bg-slate-50 transition duration-300">
                                ...
                                <span class="block text-xs text-slate-400 mb-3">Format: PDF (Maks 25MB). SK Pembimbing/Pelatih Ekskul, laporan program kerja ekskul pramuka/lainnya.</span>
                            ...
                            <div class="border border-slate-200 rounded-2xl p-5 hover:bg-slate-50 transition duration-300">
                                ...
                                <span class="block text-xs text-slate-400 mb-3">Format: PDF (Maks 25MB). Sertifikat pelatihan, piagam kejuaraan, atau penghargaan keahlian kerja.</span>
                ...
                <div class="step-pane step-transition hidden" id="step5">
                        ...
                        <div class="bg-white border border-slate-200 rounded-2xl p-6 flex flex-col justify-between md:col-span-2">
                            <div>
                                ...
                                <p class="text-xs text-slate-500 leading-relaxed">
                                    Biaya jasa layanan pendaftaran dan pendampingan registrasi di SALUT Bandung adalah sebesar **Rp 400.000**. Setelah Anda mentransfer jumlah tersebut ke rekening di samping, silakan unggah foto/scan tanda bukti transfer yang sah di bagian bawah halaman ini.
                                </p>
                            </div>
                    ...
                    <div class="border-2 border-dashed border-brand-200 rounded-3xl p-6 sm:p-8 bg-brand-50/20 text-center mb-8 hover:bg-brand-50/40 transition duration-300">
                        <div class="max-w-md mx-auto">
                            ...
                            <span class="block text-xs text-slate-400 mb-4">Format berkas: JPG, JPEG, PNG (Maksimal 25 MB).</span>
                    ...
                    fetch(`${GITHUB_URL}kabupaten/${selectedProvinsiId}.json`)
                        ...
                        .then(data => {
                            ...
                            if (savedData['kab_kota']) {
                                const optionExists = Array.from(kabKotaDropdown.options).some(opt => opt.value === savedData['kab_kota']);
                                if (optionExists) {
                    ...
                    fetch(`${GITHUB_URL}kabupaten/${selectedProvinsiId}.json`)
                        ...
                        .then(data => {
                            ...
                            if (savedData['lokasi_ujian_kab_kota']) {
                                const optionExists = Array.from(lokasiUjianKabKotaDropdown.options).some(opt => opt.value === savedData['lokasi_ujian_kab_kota']);
                                if (optionExists) {
                                    lokasiUjianKabKotaDropdown.value = savedData['lokasi_ujian_kab_kota'];
                                }
                            }
                        });
                }
                    ...
                    fetch(`${GITHUB_URL}kecamatan/${selectedKabKotaId}.json`)
                        ...
                        .then(data => {
                            ...
                            if (savedData['kecamatan']) {
                                const optionExists = Array.from(kecamatanDropdown.options).some(opt => opt.value === savedData['kecamatan']);
                                if (optionExists) {
                    ...
                    fetch(`${GITHUB_URL}kelurahan/${selectedKecamatanId}.json`)
                        ...
                        .then(data => {
                            ...
                            if (savedData['desa_kelurahan']) {
                                const optionExists = Array.from(desaKelurahanDropdown.options).some(opt => opt.value === savedData['desa_kelurahan']);
                                if (optionExists) {
                    ...
                    input.addEventListener('change', function() {
                        ...
                        if (file) {
                            ...
                            if (!allowedMimes.includes(file.type) && !file.name.toLowerCase().endsWith('.jpg') && !file.name.toLowerCase().endsWith('.jpeg') && !file.name.toLowerCase().endsWith('.png')) {
                                ...
                                alert('Ukuran file terlalu besar! Ukuran berkas maksimum adalah 25 Megabytes (25 MB).');
                                this.value = '';
                            }
                        }
                    });
