...
<body class="bg-slate-50 text-slate-800 font-sans min-h-screen flex flex-col antialiased">
    ...
    <!-- Header Hero Section -->
    <section class="relative bg-gradient-to-r from-brand-950 to-brand-800 text-white py-16 overflow-hidden pt-28">
        <div class="absolute inset-0 opacity-15">
            ...
            <div class="w-full h-full bg-[radial-gradient(#ffffff_1px,transparent_1px)] [background-size:24px_24px]">
            </div>
        </div>
        <div class="max-w-4xl mx-auto px-4 text-center relative z-10">
            <span
                class="inline-flex items-center space-x-2 bg-brand-700/50 text-gold-300 text-xs font-semibold px-4 py-1.5 rounded-full mb-4 border border-brand-500/30 uppercase tracking-widest">
                Formulir Pendaftaran
            </span>
            <h1 class="text-4xl md:text-5xl font-extrabold font-outfit tracking-tight mb-4 text-white">Pendaftaran Calon
                Mahasiswa</h1>
            <p class="text-lg text-slate-200 max-w-2xl mx-auto font-light leading-relaxed">
                Silakan isi data diri Anda secara lengkap dan unggah berkas persyaratan yang diperlukan melalui sistem
                pendaftaran pintar di bawah.
            </p>
        </div>
    </section>

    <!-- Main Registration Container -->
    <main class="flex-1 max-w-5xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-20">
        ...
        <div class="bg-white rounded-3xl shadow-xl border border-slate-100 overflow-hidden">
            ...
            <div class="bg-slate-50/80 border-b border-slate-100 px-6 py-6 sm:px-10">
                <div class="flex items-center justify-between relative max-w-3xl mx-auto">
                    ...
                    <div id="step-bar"
                        class="absolute left-0 top-1/2 -translate-y-1/2 h-1 bg-brand-500 z-0 transition-all duration-500"
                        style="width: 0%;"></div>

                    <!-- Step 1 Indicator -->
                    <div class="relative z-10 flex flex-col items-center step-node active" data-step="1">
                        <div
                            class="w-10 h-10 rounded-full bg-brand-600 text-white flex items-center justify-center font-bold shadow-md transition duration-300 ring-4 ring-brand-100">
                            1</div>
            ...
            <form action="{{ route('pendaftaran.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="nama" name="nama" required
                                class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-brand-500 transition"
                        ...
                        <!-- Jenis Kelamin -->
                        <div>
                            <label for="gender" class="block text-sm font-semibold text-slate-700 mb-2">Jenis Kelamin
                                <span class="text-red-500">*</span></label>
                            <select id="gender" name="gender" required
                                class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-brand-500 transition bg-white">
                ...
                <div class="step-pane step-transition hidden" id="step2">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div>
                            ...
                            <select id="kab_kota" name="kab_kota" required disabled
                                class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-brand-500 transition bg-white disabled:bg-slate-100 disabled:text-slate-400">
                        ...
                        <div class="flex space-x-6">
                            <label class="flex items-center space-x-3 cursor-pointer">
                                <input type="radio" name="alamat_pengirim_modul" value="ya"
                                    ...
                                    class="h-4 w-4 text-brand-600 border-slate-300 focus:ring-brand-500">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <!-- Email -->
                        <div>
                            <label for="email" class="block text-sm font-semibold text-slate-700 mb-2">Alamat Email
                ...
                <div class="step-pane step-transition hidden" id="step3">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <!-- RPL Card -->
                            <div class="relative border-2 border-slate-200 rounded-2xl p-6 cursor-pointer hover:border-brand-300 transition duration-300"
                                id="card_jalur_rpl">
                                <div class="flex items-start">
                                    <div class="flex items-center h-5">
                                        <input id="jalur_program_rpl" name="jalur_program" type="radio"
                                            value="RPL" required
                                            class="focus:ring-brand-500 h-5 w-5 text-brand-600 border-slate-300">
                                    </div>
                                    <label for="jalur_program_rpl" class="ml-3 cursor-pointer">
                                        <span class="block text-lg font-bold text-brand-900 font-outfit">Jalur RPL
                                            (Rekognisi Pembelajaran Lampau)</span>
                                        <span class="block text-xs text-slate-500 mt-1 leading-relaxed">
                                            Bagi calon pendaftar lulusan D1/D2/D3/S1 atau yang memiliki pengalaman kerja
                                            formal untuk dikonversi menjadi sks perkuliahan.
                                        </span>
                                        <span
                                            class="inline-block mt-3 bg-brand-50 text-brand-700 text-xs font-bold px-2.5 py-1 rounded-md"><span>Uang
                                                Pendaftaran + Jasa Layanan SALUT Rp. 800.000</span>
                                            <span
                                                class="inline-block mt-3 bg-brand-50 text-brand-700 text-xs font-bold px-2.5 py-1 rounded-md"><span>Uang
                                                    Kuliah Mulai Rp 1.300.000 s/d Rp 2.200.000</span>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="relative border-2 border-slate-200 rounded-2xl p-6 cursor-pointer hover:border-brand-300 transition duration-300"
                                ...
                                <div class="flex items-start">
                                    ...
                                    <label for="jalur_program_nonrpl" class="ml-3 cursor-pointer">
                                        <span class="block text-lg font-bold text-slate-800 font-outfit">Jalur Reguler
                                            (Non-RPL / Lulusan SMA Baru)</span>
                                        <span class="block text-xs text-slate-500 mt-1 leading-relaxed">
                                            Bagi lulusan baru SMA/SMK/MA/Paket C sederajat yang memulai kuliah reguler
                                            dari semester 1 tanpa transfer sks.
                                        </span>
                                        <span
                                            class="inline-block mt-3 bg-slate-100 text-slate-700 text-xs font-bold px-2.5 py-1 rounded-md">Uang
                                            Pendaftaran + Jasa Layanan SALUT Rp. 500.000</span>
                                        <span
                                            class="inline-block mt-3 bg-slate-100 text-slate-700 text-xs font-bold px-2.5 py-1 rounded-md">Uang
                                            Kuliah Mulai Rp 1.300.000 s/d Rp 2.200.000</span>
                                    </label>
                    ...
                    <div id="non_rpl_description"
                        class="mb-8 p-6 rounded-2xl bg-brand-50 border border-brand-100 text-slate-700">
                ...
                <div class="step-pane step-transition hidden" id="step4">
                    <div class="border-b border-slate-100 pb-4 mb-6">
                        ...
                        <p class="text-sm text-slate-500">Unggah salinan dokumen resmi Anda dalam format yang
                            ditentukan. Maksimum ukuran per berkas adalah **2 MB**.</p>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                        ...
                        <div class="border border-slate-200 rounded-2xl p-5 hover:bg-slate-50 transition duration-300">
                            ...
                            <input type="file" name="file_foto" id="file_foto" required
                                ...
                                class="w-full text-xs text-slate-500 file:mr-4 file:py-2.5 file:px-4 file:rounded-xl file:border-0 file:text-xs file:font-semibold file:bg-brand-50 file:text-brand-700 hover:file:bg-brand-100 transition">
                        </div>
                        ...
                        <div class="border border-slate-200 rounded-2xl p-5 hover:bg-slate-50 transition duration-300">
                            <div class="flex justify-between items-start mb-1">
                                ...
                                <a href="https://salutbandung.com/pernyataan-keabsahan" target="_blank"
                                    class="text-xs text-brand-600 hover:underline font-bold flex items-center">
                ...
                <div id="rpl_file_section" class="hidden border-t border-slate-100 pt-8 mt-6">
                    <div class="mb-6">
                        <h3 class="text-lg font-bold text-brand-900 font-outfit">Berkas Khusus Tambahan Alih Kredit
                            (RPL)</h3>
                        <p class="text-xs text-slate-400">Berkas-berkas di bawah ini diwajibkan khusus untuk verifikasi
                            alih kredit mahasiswa alihan / lulusan diploma.</p>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div
                            ...
                            <span class="block text-xs text-slate-400 mb-3">Format: JPG, JPEG, PNG (Maks 25MB). Status
                                terdaftar aktif / lulus di Universitas lama.</span>
                            <input type="file" name="file_ss_pddikti" id="file_ss_pddikti"
                                accept=".jpg,.jpeg,.png,image/jpeg,image/png"
                                class="w-full text-xs text-slate-500 file:mr-4 file:py-2.5 file:px-4 file:rounded-xl file:border-0 file:text-xs file:font-semibold file:bg-brand-50 file:text-brand-700 hover:file:bg-brand-100 transition bg-white">
                        </div>
                        ...
                        <div
                            class="border border-amber-100 bg-amber-50/20 rounded-2xl p-5 hover:bg-slate-50 transition duration-300">
                            <div class="flex justify-between items-start mb-1">
                                <span class="block text-sm font-bold text-slate-700">Daftar Riwayat Hidup (CV) <span
                                        class="text-red-500">*</span></span>
                            ...
                            <span class="block text-xs text-slate-400 mb-3">Format: PDF (Maks 25MB). Unduh formulir di
                                atas, isi lengkap riwayat Anda, simpan sebagai PDF.</span>
                        ...
                        <div
                            ...
                            <span class="block text-sm font-bold text-slate-700 mb-1">Surat Keterangan Pindah (Dari
                                Kampus Asal) <span class="text-xs text-slate-400 font-normal">(Opsional)</span></span>
                            <span class="block text-xs text-slate-400 mb-3">Format: PDF (Maks 25MB). Hanya bagi calon
                                mahasiswa pindahan antar universitas.</span>
                        ...
                        <div class="col-span-1 md:col-span-2 border-t border-dashed border-slate-200 pt-6 mt-4">
                            <h4 class="text-sm font-bold text-slate-700 mb-1">Dokumen Pendukung Portofolio RPL (Khusus
                                Alih Kredit Berbasis Kerja)</h4>
                            <p class="text-xs text-slate-400 mb-4">Unggah dokumen di bawah ini jika Anda ingin
                                mengklaim mata kuliah dari portofolio pengalaman kerja (Opsional).</p>
                        </div>

                        <!-- File RPL Pembelajaran -->
                        <div class="border border-slate-200 rounded-2xl p-5 hover:bg-slate-50 transition duration-300">
                            <span class="block text-sm font-bold text-slate-700 mb-1">Dokumen Perangkat Pembelajaran
                        ...
                        <div class="border border-slate-200 rounded-2xl p-5 hover:bg-slate-50 transition duration-300">
                            <span class="block text-sm font-bold text-slate-700 mb-1">Dokumen Administrasi Kelas <span
                                    class="text-xs text-slate-400 font-normal">(Opsional)</span></span>
                            <span class="block text-xs text-slate-400 mb-3">Format: PDF (Maks 25MB). Surat keputusan
                                pembagian tugas mengajar, daftar nilai siswa, absensi.</span>
                        ...
                        <div class="border border-slate-200 rounded-2xl p-5 hover:bg-slate-50 transition duration-300">
                            <span class="block text-sm font-bold text-slate-700 mb-1">Dokumen Pembina Ekstrakurikuler
                                <span class="text-xs text-slate-400 font-normal">(Opsional)</span></span>
                        ...
                        <!-- File RPL Prestasi -->
                        <div class="border border-slate-200 rounded-2xl p-5 hover:bg-slate-50 transition duration-300">
                            <span class="block text-sm font-bold text-slate-700 mb-1">Sertifikat Penghargaan / Prestasi
                                <span class="text-xs text-slate-400 font-normal">(Opsional)</span></span>
        ...
        <div class="step-pane step-transition hidden" id="step5">
            <div class="border-b border-slate-100 pb-4 mb-6">
                <h2 class="text-2xl font-bold font-outfit text-slate-800">Langkah 5: Informasi Jasa Layanan & Bukti
                    Pembayaran</h2>
                <p class="text-sm text-slate-500">Selesaikan biaya administrasi pendampingan pendaftaran di SALUT Kota
                    Bandung untuk memproses berkas Anda ke pusat.</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div
                    ...
                    <div>
                        <span class="block text-xs text-slate-400 font-semibold uppercase tracking-wider mb-1">Transfer
                            Bank Resmi</span>
                        <span class="block text-2xl font-extrabold font-outfit text-gold-300">BRI (Bank Rakyat
                            Indonesia)</span>
                    </div>
                    <div class="mt-6">
                ...
                <div
                    ...
                    <div>
                        <h3 class="text-base font-bold text-slate-800 mb-2 flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-brand-600"
                        ...
                        <p class="text-xs text-slate-500 leading-relaxed">
                            Biaya jasa layanan pendaftaran dan pendampingan registrasi di SALUT Bandung adalah sebesar
                            **Rp 400.000**. Setelah Anda mentransfer jumlah tersebut ke rekening di samping, silakan
                            unggah foto/scan tanda bukti transfer yang sah di bagian bawah halaman ini.
                        </p>
                    </div>
                    <div
                        class="border-t border-slate-100 pt-4 mt-4 flex items-center space-x-2 text-slate-600 text-xs">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-emerald-500" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                        </svg>
                        <span class="font-medium">Transaksi dijamin aman, diverifikasi oleh sistem audit keuangan SALUT
                            Bandung.</span>
                    </div>
                </div>
            </div>
            ...
            <!-- Ukuran Almamater -->
            <div class="mb-8">
                <label for="ukuran_almat" class="block text-sm font-semibold text-slate-700 mb-2">Ukuran Jas Almamater
                    (Opsional)</label>
            ...
            <div
                class="border-2 border-dashed border-brand-200 rounded-3xl p-6 sm:p-8 bg-brand-50/20 text-center mb-8 hover:bg-brand-50/40 transition duration-300">
                <div class="max-w-md mx-auto">
                    <div
                        class="w-12 h-12 rounded-full bg-brand-100 text-brand-600 flex items-center justify-center mx-auto mb-4">
                    ...
                    <span class="block text-base font-bold text-slate-800 mb-1">Unggah Tanda Bukti Transfer Pembayaran
                        <span class="text-red-500">*</span></span>
                    ...
                    <input type="file" name="file_bukti_pembayaran" id="file_bukti_pembayaran" required
                        accept=".jpg,.jpeg,.png,image/jpeg,image/png"
                        class="w-full text-xs text-slate-500 file:mr-4 file:py-2.5 file:px-5 file:rounded-full file:border-0 file:text-xs file:font-semibold file:bg-brand-600 file:text-white hover:file:bg-brand-700 transition">
                </div>
            </div>
            ...
            <div
                ...
                <input type="checkbox" id="declaration_check" required
                    class="h-5 w-5 rounded text-brand-600 border-slate-300 focus:ring-brand-500 mt-0.5">
                <label for="declaration_check" class="leading-relaxed cursor-pointer font-medium">
                    Saya dengan ini menyatakan bahwa seluruh informasi dan berkas dokumen yang saya masukkan ke dalam
                    formulir pendaftaran ini adalah **benar, sah, dan dapat dipertanggungjawabkan**. Apabila di kemudian
                    hari ditemukan kecurangan/pemalsuan data, saya bersedia menerima sanksi pembatalan status
                    kemahasiswaan dari Universitas Terbuka.
                </label>
            </div>
        </div>
        ...
        <div class="flex justify-between items-center border-t border-slate-100 pt-6 mt-8">
            ...
            <button type="button" id="nextBtn"
                class="inline-flex items-center space-x-2 bg-brand-600 hover:bg-brand-700 text-white font-bold px-8 py-3 rounded-2xl transition duration-300 shadow-md shadow-brand-500/20">
                <span>Lanjutkan</span>
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // currentStep and maxReachedStep are loaded from sessionStorage at the top
            const totalSteps = 5;
            const form = document.getElementById('registrationForm');
            const prevBtn = document.getElementById('prevBtn');
            const nextBtn = document.getElementById('nextBtn');

            // Trigger UI update if resuming from a saved step
            if (currentStep > 1) {
                setTimeout(() => {
                    updateWizardUI();
                    window.scrollTo({
            ...
            function updateWizardUI() {
                ...
                document.querySelectorAll('.step-node').forEach((node) => {
                    ...
                    if (stepNum < currentStep) {
                        ...
                        // Current Step
                        circle.className =
                            "w-10 h-10 rounded-full bg-brand-600 text-white flex items-center justify-center font-bold shadow-md transition duration-300 ring-4 ring-brand-100";
                ...
                if (currentStep === totalSteps) {
                    ...
                    `;
                    nextBtn.className =
                        "inline-flex items-center space-x-2 bg-brand-600 hover:bg-brand-700 text-white font-bold px-8 py-3 rounded-2xl transition duration-300 shadow-md shadow-brand-500/20";
                }
            }
            ...
            nextBtn.addEventListener('click', function(e) {
                if (validateCurrentStep()) {
                    if (currentStep < totalSteps) {
                        ...
                        if (confirm(
                                'Apakah Anda yakin seluruh berkas dan data diri sudah terisi dengan benar?'
                            )) {
            ...
            document.querySelectorAll('.step-node').forEach((node) => {
                node.addEventListener('click', function() {
                    ...
                    if (stepNum <= maxReachedStep && stepNum !== currentStep) {
                        // Jika mencoba melompat ke langkah depan, validasi langkah saat ini dulu
                        if (stepNum > currentStep) {
            ...
            function handleJalurChange() {
                ...
                if (isRpl) {
                    cardRpl.className =
                        "relative border-2 border-brand-500 bg-brand-50/10 rounded-2xl p-6 cursor-pointer transition duration-300";
                    cardNonRpl.className =
                        "relative border border-slate-200 rounded-2xl p-6 cursor-pointer hover:border-brand-300 transition duration-300";
            ...
            <div class="modal-header">
                <div class="flex items-center gap-3">
                    <div class="w-8 h-8 rounded-full bg-brand-100 flex items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-brand-600" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <button id="close-preview-modal"
                    class="w-9 h-9 rounded-xl bg-slate-100 hover:bg-slate-200 flex items-center justify-center text-slate-500 hover:text-slate-700 transition">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    @if (session('success'))
        <script>
            Swal.fire({
                ...
                confirmButtonColor: '#3b5cff'
            });
        </script>
    @endif

    <!-- Alert untuk error - TAMPILKAN SPESIFIK PER FIELD -->
    @if ($errors->any())
        <script>
            let errorMessages = [];
            ...
            // Jika tidak ada error unique, tampilkan error lainnya
            @if (!$errors->has('nik') && !$errors->has('no_hp') && !$errors->has('email'))
