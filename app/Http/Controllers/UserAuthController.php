...
class UserAuthController extends Controller
{
    ...
    public function updateProfile(Request $request)
    {
        ...
        $rules = [
            ...
            'file_transkrip' => 'nullable|mimes:pdf|max:2048',
            'file_bukti_pembayaran' => 'nullable|mimes:pdf,jpg,jpeg,png|max:2048',
            'surat_pernyataan' => 'nullable|mimes:pdf|max:2048',
            'file_cv' => 'nullable|mimes:pdf|max:2048',
            'file_ss_pddikti' => 'nullable|image|mimes:jpg,jpeg,png|max:2048',
            'file_rpl_pembelajaran' => 'nullable|mimes:pdf|max:2048',
            'file_rpl_administrasi' => 'nullable|mimes:pdf|max:2048',
            'file_rpl_ekstrakulikuler' => 'nullable|mimes:pdf|max:2048',
            'file_rpl_prestasi' => 'nullable|mimes:pdf|max:2048',
            'surat_keterangan_pindah' => 'nullable|mimes:pdf|max:2048',
        ];
        ...
        $customMessages = [
            ...
            'file_ktp.image' => 'File KTP harus berupa gambar (JPG, JPEG, PNG).',
            ...
            'file_bukti_pembayaran.mimes' => 'File Bukti Pembayaran harus berformat PDF, JPG, JPEG, atau PNG.',
            ...
            'file_ss_pddikti.image' => 'File SS PDDIKTI harus berupa gambar (JPG, JPEG, PNG).',
