...
class SalutPendaftaranController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $customMessages = [
            ...
            'file_transkrip.mimes' => 'File Transkrip Nilai harus berformat JPG, JPEG, PNG, atau PDF.',
            ...
            'surat_keterangan_pindah.mimes' => 'Surat Keterangan Pindah harus berformat JPG, JPEG, PNG, atau PDF.',
        ...
        $validatedData = $request->validate([
            ...
            'file_ijazah' => 'required|file|mimes:jpg,jpeg,png,pdf|max:25600',
            'no_ijazah' => 'required|string|max:255',
            'ipk' => 'numeric|nullable|min:2.00|max:4.00',
            'file_bukti_pembayaran' => 'required|file|mimes:jpg,jpeg,png,pdf|max:25600',
            'surat_pernyataan' => 'required|file|mimes:jpg,jpeg,png,pdf|max:25600',
            'file_foto' => 'required|image|mimes:jpeg,png,jpg|max:25600',
            'file_ktp' => 'required|file|mimes:jpg,jpeg,png,pdf|max:25600',
            'file_ss_pddikti' => 'nullable|file|mimes:jpg,jpeg,png,pdf|max:25600',
            'file_transkrip' => 'nullable|file|mimes:jpg,jpeg,png,pdf|max:25600',
            'file_rpl_pembelajaran' => 'nullable|file|mimes:jpg,jpeg,png,pdf|max:25600',
            'file_rpl_administrasi' => 'nullable|file|mimes:jpg,jpeg,png,pdf|max:25600',
            'file_rpl_ekstrakulikuler' => 'nullable|file|mimes:jpg,jpeg,png,pdf|max:25600',
            'file_rpl_prestasi' => 'nullable|file|mimes:jpg,jpeg,png,pdf|max:25600',
            'surat_keterangan_pindah' => 'nullable|file|mimes:jpg,jpeg,png,pdf|max:25600',
            'file_cv' => 'nullable|file|mimes:jpg,jpeg,png,pdf|max:25600',
